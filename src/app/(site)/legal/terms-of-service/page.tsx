  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            applications or services provided by the Company.
          </p>
        </li>
        <li>
          <p>
      ...
      <p>
        ...
        the agreement that operates between You and the Company. These Terms set
        out the rights and obligations of all users regarding the use of the
        Service.
      </p>
      <p>
        Your access to and use of the Service is conditioned on Your acceptance
        of and compliance with these Terms and Conditions. These Terms apply to
        all visitors, users, and others who access or use the Service.
      </p>
      <p>
        By accessing or using the Service You agree to be bound by these Terms
        and Conditions. If You disagree with any part of these Terms then You
      ...
      <p>
        The Service provides a browser-based application that allows users to
        access their device's camera to detect and identify colors in real time.
        Users can capture color information, including HEX and RGB values, by
        interacting with the application directly through their web browser
      ...
      <ul>
        ...
        <li>
          <p>Not use the Service for any unlawful or unauthorized purpose.</p>
        </li>
        <li>
          <p>
            Not attempt to interfere with or compromise the integrity or
            security of the Service.
          </p>
        </li>
        <li>
          <p>
            Not engage in any activity that could harm or disrupt the Service or
            other users.
          </p>
        </li>
        <li>
          <p>
            Respect the intellectual property rights of the Company and any
            third parties.
          </p>
        </li>
      </ul>
      ...
      <p>
        ...
        Portugal and foreign countries.
      </p>
      <p>
      ...
      <p>
        ...
        the Service, third-party software and/or third-party hardware used with
      ...
      <p>
        ...
        means that some of the above limitations may not apply. In such
      ...
      <h2>Governing Law</h2>
      <p>
        The laws of Portugal, excluding its conflicts of law rules, shall govern
        these Terms and Your use of the Service. Your use of the Service may
