...
export default function HomePage() {
  ...
  return (
    <>
      <header className="max-w-xs flex justify-between items-center py-4 mx-auto">
          ...
          <ul className="space-y-4">
            ...
            <li className="flex items-start">
              ...
              <div>
                ...
                <p>
                  We take your privacy seriously. All color detection is
                  performed directly on your device. Your camera feed is never
                  transmitted or stored on any server, ensuring your data
